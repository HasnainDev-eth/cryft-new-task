...
function Swap(props) {
  ...
  const _swap_cryft_for_bnb = async (amount) => {
    try {
      ...
      console.log(BigNumber.from("1000000000000060000").toHexString());
      if (props.login_method === "Email") {
        console.log("Email");
        const _tx = await props.token_contract.approve(
          "0x653FA1A976837D3B4D5a12c5FEe414a9823FD688",
          _busdInWei.toString(),
          {
            gasPrice: "10000000000",
          }
    ...
    <div className="col-md-9">
      ...
      <div className="Swap-content">
        ...
        <div className="swap" style={{ marginRight: "10px" }}>
          <div className="card-body">
            <div className="card-input input-group">
              ...
              <div>
                <h6 style={{ color: "white" }}>Gas Usage: 0.01 to 0.004 BNB</h6>
              </div>
            </div>
        ...
        <>
          {scode ? (
            <>
              <Swapping settercode={settercode} code={code} />
            </>
          ) : (
            <></>
          )}
